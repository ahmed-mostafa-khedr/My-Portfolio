  ...
  const fProjects = [
    {
      title: "leon Template",
      description:
        "Web Template  To Display The Work Of An Agency Or Company Or Team",
      imgUrl: p1,
    ...
    },
    {
      ...
      description:
        " Responsive Web Template includes more animations and effects  To Display The Work Of An Agency Or Company Or Team ",
      imgUrl: p2,
    ...
    },
    {
      ...
      description:
        " Responsive Web Site includes more animations and effects  To Display The Work Of Team",
      imgUrl: p3,
      link: "https://kasper-test-template.netlify.app/",
    },
    {
      title: "Shopping Cart",
      description:
        " Responsive Web Site  Through it you can view products or subscribe to add products to your Cart ",
      imgUrl: p4,
    ...
    },
    {
      ...
      description:
        "Simple Test Game  Depend on matching between the two players  ",
      imgUrl: p6,
    ...
    },
    {
      ...
      description:
        "Simple page make a simple dates reminder with ability to view or delete all dates",
      imgUrl: p7,
    ...
    },
    {
      ...
      description:
        "Simple Resturant Menu to view many meals with ability to serarch about fav food or wiew menu depend on food type by filter",
      imgUrl: p8,
    ...
    },
    {
      title: "Cinema Store",
      description:
        "movies web site fetch data from real api and view all details about movie",
      imgUrl: p9,
    ...
    },
    {
      ...
      description:
        "small E-commerce website view many products and enable visitor to subscribe to can buy a products",
      imgUrl: p10,
        ...
        <Row>
          <Col size={12}>
            <div>
              <h2>Projects</h2>
              <p>
                I enjoy every step of the developement process, from discussion
